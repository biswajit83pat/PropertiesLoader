...
public class WeatherEndpointTest {
    ...
    public void testGetNearby() throws Exception {
        ...
        _dp.setMean(40);// CR: Should change to add new Builder pattern. This should get changed.
        _update.updateWeather("EWR", "wind", _gson.toJson(_dp));
        _dp.setMean(30);// CR: Should change to add new Builder pattern. This should get changed.
