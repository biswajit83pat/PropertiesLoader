 ...
 */
class AtmosphericInformation {//CR: Should add public modifier for this class 
    ...
    protected long getLastUpdateTime() {// CR: change to public modifier for accessor method
        return this.lastUpdateTime;
    }
    protected void setLastUpdateTime(long lastUpdateTime) {// CR: change to public modifier for mutator method 
        this.lastUpdateTime = lastUpdateTime;
    }// CR: Should have equals() and hashCode() methods implemented so that it can be used in a Map
}
